...
| ГОСБ | Ссылка | QR-код |
|------|--------|--------|
| Аппарат Банка | [Перейти](https://registration-app.vercel.app/register/apparat) | ![QR](https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://registration-app.vercel.app/register/apparat) |
| Башкирский ГОСБ | [Перейти](https://registration-app.vercel.app/register/bashkir) | ![QR](https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://registration-app.vercel.app/register/bashkir) |
| Челябинский ГОСБ | [Перейти](https://registration-app.vercel.app/register/chelyabinsk) | ![QR](https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://registration-app.vercel.app/register/chelyabinsk) |
| Югорский ГОСБ | [Перейти](https://registration-app.vercel.app/register/ugra) | ![QR](https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://registration-app.vercel.app/register/ugra) |
